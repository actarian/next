import {
  Select as BaseSelect, SelectArrow, SelectItem as BaseSelectItem, SelectPopover,
  useSelectState
} from 'ariakit/select';
...
export const Select = forwardRef<HTMLButtonElement, SelectProps>(({ children, value, setValue, defaultValue, onClose, ...props }, ref) => {
  const select = useSelectState({
    value, setValue, defaultValue, sameWidth: true, setVisible: (visible) => {
      if (!visible && onClose) {
        onClose();
      }
    },
